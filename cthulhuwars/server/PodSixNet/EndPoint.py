...
if __name__ == "__main__":
    ...
    class FailEndPointTestCase(unittest.TestCase):
        ...
        def runTest(self):
            ...
            self.assertEqual(list(self.endpoint_bad.result), list(want),
    ...
    class EndPointTestCase(unittest.TestCase):
        def setUp(self):
            self.outgoing = [
                {"action": "hello",
                 "data": {"a": 321, "b": [2, 3, 4], "c": ["afw", "wafF", "aa", "weEEW", "w234r"], "d": ["x"] * 256}},
                {"action": "hello", "data": [454, 35, 43, 543, "aabv"]},
                {"action": "hello", "data": [10] * 512},
                {"action": "hello", "data": [10] * 512, "otherstuff": "hello\0---\0goodbye", "x": [0, "---", 0],
                 "y": "zäö"},
            ]
